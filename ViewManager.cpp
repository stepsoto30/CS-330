...
void ViewManager::ProcessKeyboardEvents()
{
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_D) == GLFW_PRESS)
	{
		g_pCamera->ProcessKeyboard(RIGHT, gDeltaTime);
							...
							/* NEW */
	// Allowing the camera to move up and down by pressing Q = up and E = down
	...
	// process camera to toggle to perspective
	if (glfwGetKey(m_pWindow, GLFW_KEY_P))
	{
		bOrthographicProjection = false;

	}
	// process camera to toggle to orthographic
...
void ViewManager::PrepareSceneView()
{
	...
	else
	{
		...
		// Fits the entire height of the cat tree comfortably
		...
		// Force camera to look straight at the object 
		// The position of the camera had to be increased by the y-axis and z-axis in order to fit the cat tree
